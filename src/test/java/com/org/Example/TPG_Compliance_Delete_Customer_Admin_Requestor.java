...
public class TPG_Compliance_Delete_Customer_Admin_Requestor {
	WebDriver driver;
	String baseUrl;
	...
	@Test
	public void TPG_Compliance_Delete() throws Exception {
		...
		if(listInputs.size()>0)
		 {
			...
			System.out.println("Success: Deleted TP Group Compliance");
			}
		else{
			System.out.println("There is No Trading Partner Group Requirements to Edit");
		}
